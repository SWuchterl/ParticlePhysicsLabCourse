...
x_fit = np.linspace(1747, 2250, num=2250. - 1747.)
...
noise = [48., 228., 680., 4674., 33864., 93626.,
         143209., 183382., 210260., 242282., 302262.]
...
fig.tight_layout()
plt.savefig('efficiency_fitPMT_3_fourth.pdf', format='pdf')
...
with open('PMT3_fourth.txt', 'wb') as f:
