...
mc_samples = ['Plots/ttbar.root', 'Plots/dy.root', 'Plots/wjets.root',
              'Plots/ww.root', 'Plots/wz.root', 'Plots/zz.root', 'Plots/qcd.root']
...
for variable in list_of_variables:
    ...
    # W+jets
    wjets = ROOT.TH1F('W+jets background',
                      'W+jets background', NBINS, XLOW, XUP)
...
# ERROR BAND
line_up = ROOT.TLine(0., eff_value + 0.05 * eff_value,
                     152., eff_value + 0.05 * eff_value)
line_up.SetLineStyle(2)
line_down = ROOT.TLine(0., eff_value - 0.05 * eff_value,
                       152., eff_value - 0.05 * eff_value)
